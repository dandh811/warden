...
from apps.tasks.lib.settings import TIMEOUT
...
def parse_html(host):
    ...
    try:
        ...
        r = requests.get(host, headers=get_ua(), timeout=3, verify=False)
...
if __name__ == "__main__":
    host = 'http://43.247.91.228:84/Less-1/?id=1'
    logger.info(sql_check(host))
