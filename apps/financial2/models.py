...
class Investors(models.Model):
    id = models.AutoField(primary_key=True)
    openid = models.CharField(max_length=64, default='', verbose_name="投资人openid")
    session_key = models.CharField(max_length=64, default='', verbose_name="投资人session_key")

    nick = models.CharField(max_length=64, default='', verbose_name="投资人昵称")
    avaurl = models.CharField(max_length=200, default='', verbose_name="投资人头像")
    city = models.CharField(max_length=30, default='', verbose_name="投资人城市")
    sex = models.CharField(max_length=5, default='', verbose_name="投资人性别")
